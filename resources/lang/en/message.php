...
return [
  ...
  "services_required"=>"Type oF service required",
  "required_required"=>' Phone Number  Is required',
  "email_required"=>' Email Is required',
  "email_email"=>' The Email Is Not Correct! ',
  ...
  "decor1"=>"Proper ",
  "decor2"=>" interior design",
  "decor3"=>" improves your mood.",


  "umber1"=>" Umbrellas reduce ",
  "umber2"=>"temperature and provide ",
  "umber3"=>"a cool environment",


  "Our_vission"=>"Our vision",
    "Our_message"=>"Our message",
    "Our_misson"=>"Our misson",
